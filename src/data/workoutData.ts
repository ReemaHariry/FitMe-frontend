      ...
      },
      {
        ...
        levels: {
          beginner: {
            ...
            videoUrl: "https://www.youtube.com/embed/LSkyinhmA8k",
      ...
      },
      {
        ...
        levels: {
          beginner: {
            ...
            videoUrl: "https://www.youtube.com/embed/6zyx46Vpato",
    ...
    exercises: [
      {
        ...
        levels: {
          beginner: {
            ...
            videoUrl: "https://www.youtube.com/embed/fnJ0F1Xsu7Y",
    ...
    exercises: [
      {
        ...
        levels: {
          ...
          intermediate: {
            label: "Goblet Squats",
            videoUrl: "https://www.youtube.com/embed/Mu7aVOjEBdA",
    ...
    exercises: [
      {
        ...
        levels: {
          ...
          intermediate: {
            ...
            videoUrl: "https://www.youtube.com/embed/OtOayZUX370",
    ...
    exercises: [
      {
        ...
        levels: {
          beginner: {
            label: "Goblet Squat",
            videoUrl: "https://www.youtube.com/embed/-bJIpOq-LWk",
    ...
    exercises: [
      {
        ...
        levels: {
          ...
          intermediate: {
            label: "Goblet Squats",
            videoUrl: "https://www.youtube.com/embed/0EpP3pYUYTk",
            steps: ["Hold weight at chest", "Squat deep"],
            tips: ["Upright torso"]
          },
          advanced: {
    ...
    exercises: [
      ...
      },
      {
        ...
        levels: {
          beginner: {
            label: "Box Squats",
            videoUrl: "https://www.youtube.com/embed/7LpLZOdz68A",
